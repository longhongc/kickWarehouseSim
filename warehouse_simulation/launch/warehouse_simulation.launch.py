...
def generate_launch_description():
  ...
  pkg_robot_share = FindPackageShare(package='robot_model').find('robot_model')
  ...
  start_gazebo_cmd = IncludeLaunchDescription(
    PythonLaunchDescriptionSource(os.path.join(pkg_share, 'launch', 'empty_warehouse.launch.py')),
